                            ...
                            <div class="row">
                                ...
                                <label class="form-control-label" for="input-permission">{{ __('Permission') }}</label>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="input-role" name="permission" value="{{$permissions->name}}">
                                        <label class="form-check-label" for="input-role">{{$permissions->name}}</label>
                                    </div>
                                        @endforeach
